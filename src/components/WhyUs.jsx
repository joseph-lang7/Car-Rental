      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 ">
        ...
        <div className=" flex flex-col gap-3 mt-12 md:justify-center">
          ...
          <p className="w-full">
            ...
            unmatched experience. Don&apos;t miss the opportunity to maximize
            your savings today.
          </p>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-2 justify-center items-center mt-10 md:flex-row">
            <div>
              <RiCustomerService2Fill className="text-[#FA4226]" size={90} />
            </div>
            <div className="flex flex-col items-center text-center gap-2 md:max-w-[500px]">
              ...
              <p className="text-slate-500">
                Our commitment to excellence doesn&apos;t end when you drive off
                the lot. From booking your rental to returning your vehicle, our
                dedicated team is here to ensure your experience is nothing
          ...
          <div className="flex flex-col gap-2 justify-center items-center mt-10 md:flex-row">
            <div>
              <FaMagnifyingGlassDollar className="text-[#FA4226]" size={90} />
            </div>
            <div className="flex flex-col items-center text-center gap-2 md:max-w-[500px]">
